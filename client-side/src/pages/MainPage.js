  ...
  return (
    <div>
      ...
      <p className='lg:mx-32 opacity-40 py-6 text-justify'>
        Introdcing "Currency Converter"! This web app allows you to easily convert any currencies based on latest exchange rates.
        You can easily do the convercations that you need through this web app. All you have to do is select a date, select a source 
        currency and a target currency, And you can give some value and press "Get The Target Currency" button. Then you will be able to see the relevant Target Amount.
      </p>
